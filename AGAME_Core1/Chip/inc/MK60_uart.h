...
extern void   uart_getuint8  (UARTn_e uratn, uint8 *ui8);
...
void uart_putnum (UARTn_e uratn, const float number);          //发送数字-100~100
void uart_putn (UARTn_e uratn, const float number) ;            //发送数字0~65535
