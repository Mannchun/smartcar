...
{
    //DMA通道0初始化，PTC16触发源(默认上升沿)，源地址为PTD_B0_IN，目的地址为：IMG_BUFF，每次传输1Byte
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTC_B1_IN, (void *)ov7725_eagle_img_buff, PTC16, DMA_BYTE1, CAMERA_DMA_NUM, DADDR_KEEPON);
    ...
    port_init(PTC17, ALT1 | IRQ_RISING  | PULLDOWN | PF);     //场中断，上拉，上升沿触发中断，带滤波
