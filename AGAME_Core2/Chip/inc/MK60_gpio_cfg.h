...
#define PT_BYTE(X,n,REG)    (((Dtype *)(&(PT##X##_BASE_PTR->##REG)))->B[n])     //字节操作
#define PT_WORD(X,n,REG)    (((Dtype *)(&(PT##X##_BASE_PTR->##REG)))->W[n])     //字操作
#define PT_DWORD(X,REG)     (((Dtype *)(&(PT##X##_BASE_PTR->##REG)))->DW)       //双字操作
/* Sample usage:
